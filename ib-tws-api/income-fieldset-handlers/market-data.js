var TickType = require('../const-tick-type.js');
...
function handler_TICK_PRICE(fields) {
  fields.shift();
  fields.shift();
...
function handler_TICK_SIZE(fields) {
  fields.shift();
  fields.shift();
...
function handler_TICK_GENERIC(fields) {
  fields.shift();
  fields.shift();
  let requestId = parseInt(fields.shift());
  let tickType = parseInt(fields.shift());
...
function handler_TICK_STRING(fields) {
  fields.shift();
  fields.shift();
  let requestId = parseInt(fields.shift());
  let tickType = parseInt(fields.shift());
...
function handler_TICK_SNAPSHOT_END(fields) {
...
function handler_MARKET_DATA_TYPE(fields) {
  fields.shift();
  fields.shift();
  let requestId = parseInt(fields.shift());
...
function handler_TICK_REQ_PARAMS(fields) {
  fields.shift();
  fields.shift();
...
function handler_TICK_BY_TICK(fields) {
  fields.shift();
  let requestId = parseInt(fields.shift());
  let tickType = parseInt(fields.shift());
...
function handler_TICK_OPTION_COMPUTATION(fields) {
