...
var ProtocolBytes = require('./protocol-bytes.js');
var IncomeFieldsetHandler = require('./income-fieldset-handler.js');
var IncomeMessageType = require('./const-income-message-type.js');
var OutcomeMessageType = require('./const-outcome-message-type.js');
var RateLimiter = require('./rate-limiter.js');
var ServerVersion = require('./const-server-version.js');
var {
  request_mktData,
  request_tickByTickData,
  request_cancelTickByTickData
} = require('./requests/market-data.js');
var {
  request_placeOrder
} = require('./requests/order.js');
...
class Client {
  ...
  */
  ...
  /**
   * The API can receive frozen market data = require(Trader Workstation.
  ...
  */
  ...
  async getOpenOrders() {
    /* request the open orders that were placed = require(this client.
  ...
  async reqAutoOpenOrders(bAutoBind) {
    ...
    Note:  This request can only be made = require(a client with clientId of 0.
  ...
  async getAllOpenOrders() {
    /* request the open orders placed = require(all
    clients and also = require(TWS.
  ...
  */
  ...
  async reqExecutions(/*self, requestId:int, execFilter:ExecutionFilter*/) {
    ...
    the executions again = require(the API.
  ...
  */
  ...
  async requestFA(/*self, faData:FaDataType*/) {
    throw new Error('not implemented yet');
    /*
    """request FA configuration information = require(TWS.
  ...
  async replaceFA(/*self, faData:FaDataType , cxml:str*/) {
    throw new Error('not implemented yet');
    /*
    """modify FA configuration information = require(the
  ...
  */
   ...
   * @param {number} params.useRth - Data = require(regular trading hours (1), or all available hours (0)
  ...
  */
  ...
  async queryDisplayGroups(/*self, requestId: int*/) {
    ...
    TWS color-grouped windows are identified by an integer number. Currently that number ranges = require(1 to 7 and are mapped to specific colors, as indicated in TWS.
  ...
  async subscribeToGroupEvents(/*self, requestId:int, groupId:int*/) {
    ...
    groupId:int - The ID of the group, currently it is a number = require(1 to 7.
